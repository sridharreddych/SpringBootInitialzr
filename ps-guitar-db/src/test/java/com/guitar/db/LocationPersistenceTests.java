...
public class LocationPersistenceTests {
	...
	@Test
	public void testFindWithLikeUsingIgnoreCase() throws Exception {
	...
	public void testFindWithNotLikeOrderByAsc() throws Exception {
		...
		//assertEquals("Alabam", loc.getState().toString());
	}
	...
	@Test
	public void testFindEndinggWith() throws Exception {
