...
public class PluralsightSpringcloudM4Securecli14Application implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(PluralsightSpringcloudM4Securecli14Application.class, args);
	}
